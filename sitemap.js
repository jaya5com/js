...
';
         numDisplayed++;
          ...
          if ( z!= -1) {
             tocTable += '
<tr><td class="toc-entry-col1"><a href="' + postUrl[i] + '" title="' + postSum[i] + '">' + postTitle[i] + '</a></td><td class="toc-entry-col3">' + postLabels[i] + '</td></tr>
';
             numDisplayed++;
          }
        }
...
';
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Jumlah Postingan ' + postTitle.length + ' buah<br/></span>'; }
   else {
